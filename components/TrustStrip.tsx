...
export default function TrustStrip() {
  return (
    <section className="border-y border-forest/10 bg-paper py-6">
      <div className="relative z-10 mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-x-10 gap-y-3 px-6 text-center">
        {ITEMS.map((item) => (
